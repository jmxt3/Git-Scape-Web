...
[Working smarter with Claude in PowerPoint](/resources/tutorials/working-smarter-with-claude-in-powerpoint)Working smarter with Claude in PowerPoint

Working smarter with Claude in PowerPoint

Tutorial

[Tutorial](/resources/tutorials/working-smarter-with-claude-in-powerpoint)Tutorial

[Refining a PowerPoint with Claude](/resources/tutorials/refining-a-powerpoint-with-claude)Refining a PowerPoint with Claude

Refining a PowerPoint with Claude

Tutorial

[Tutorial](/resources/tutorials/refining-a-powerpoint-with-claude)Tutorial
...
*   Log in
    ...
    [Log in](https://claude.ai/redirect/claudedotcom.v1.36dd794a-8114-49fd-a50b-212bb98593c8/login)Log in
